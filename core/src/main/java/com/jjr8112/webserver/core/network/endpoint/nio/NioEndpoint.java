package com.jjr8112.webserver.core.network.endpoint.nio;

import com.jjr8112.webserver.core.network.connector.nio.IdleConnectionCleaner;
import com.jjr8112.webserver.core.network.connector.nio.NioAcceptor;
import com.jjr8112.webserver.core.network.connector.nio.NioPoller;
import com.jjr8112.webserver.core.network.dispacher.nio.NioDispatcher;
...
public class NioEndpoint extends Endpoint {
    ...
    private int pollerCount = Math.min(2, Runtime.getRuntime().availableProcessors());  //  Runtime.getRuntime().availableProcessors()返回当前计算资源的数量
